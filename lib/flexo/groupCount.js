...
function groupCount( request, percentCb, callback ) {
	...
	container.parent.percentCb = container.child.percentCb = getPercent.bind( container );
...
function getPercent() {
	var parentFraction = (this.parent.total !== undefined) ? (this.parent.processed / this.parent.total) : 0;
	var childFraction = (this.child.total !== undefined) ? (this.child.processed / this.child.total) : 0;
