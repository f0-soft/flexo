...
var result = [
    { count: 2246, parentSum: 306950900.86, childSum: 484736888, // оплата более, чем на 100%
        // последний элемент массива - соседи дочерней коллекции (то есть родительская коллекция)
